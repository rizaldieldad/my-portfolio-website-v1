function CardProjectDetail () {
  return (
    <div className='grid gap-4'>
      <div className='flex flex-col md:flex-row gap-8 bg-white dark:bg-zinc-800  p-8 rounded-xl shadow-sm shadow-gray-400 dark:shadow-none transition-colors duration-200'>
